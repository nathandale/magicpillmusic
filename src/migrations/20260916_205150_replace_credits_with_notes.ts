...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "tracks" ADD COLUMN "songwriters" varchar;
  ALTER TABLE "tracks" ADD COLUMN "personnel" varchar;
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "tracks" DROP COLUMN "songwriters";
  ALTER TABLE "tracks" DROP COLUMN "personnel";`)
}
